...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 29, 2022 at 07:51 PM
...
INSERT INTO `clientreq` (`cid`, `cname`, `cemail`, `cphone`, `service`, `message`) VALUES
(1, 'dilshadh', 'dilshadh@gmail.com', 2147483647, 'need a website', 'good quality working one'),
(6, 'kiran', 'calebantony1@gmail.com', 2147483647, 'hehehee', 'hahahaha'),
(7, 'mathew', 'calebantony2@gmail.com', 2147483647, 'need a  domain for website hosting', 'need a good affordable hosting platform');
...
(4, 'testing', 'testing', 2147483647, 'calebantony1@gmail.com', 'need a website'),
(5, 'need a static web site ', 'webapplication related', 2147483647, 'dilshadh@gmail.com', 'need a good quality website for my mobile shop'),
(6, 'need a website', 'webapplication', 778898907, 'calebantony2@gmail.com', 'need a good quality web application');
...
(2, 'rueben tom', 'client@gmail.com', 2147483647, 'server not responding', 'Server & Security', 'high', 'server', 'hhhhhhhhhhhhhhhhhhhhhhhh', 'Customer replay', 'Null'),
...
(4, 'nikhil', 'nikhil@gmail.com', 2147483647, 'bug in the homepage', 'Product development', 'Medium', 'bug issue', 'need to do immediate responce', 'Customer replay', 'Nill'),
(5, 'nikhil', 'nikhil@gmail.com', 2147483647, 'subjet', 'Product development', 'high', 'not working', '', 'In progress', 'img1.jpg'),
(6, 'Caleb Antony', 'calebantony2@gmail.com', 2147483647, 'website not responding', 'Product development', 'Medium', 'bug issue', 'okk aanu bhaai', 'Customer replay', 'null.jpg');
...
(38, 'mathew', 'calebantony2@gmail.com', 'caleb', 'c');
...
(16, 'closed', 2, 17, '2022-03-28', 222),
(17, 'closed', 4, 17, '2022-03-28', 3333),
(18, 'In progress', 5, 21, '2022-03-29', 300),
(19, 'pending', 6, 21, '2022-03-29', 50000);
...
--
-- Indexes for table `clientreq`
--
ALTER TABLE `clientreq`
  ADD PRIMARY KEY (`cid`);
...
--
-- AUTO_INCREMENT for table `clientreq`
--
ALTER TABLE `clientreq`
...
--
ALTER TABLE `evnttable`
  MODIFY `evid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `users`
  MODIFY `usrid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
